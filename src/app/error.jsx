    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 border border-orange-500/30 shadow-xl">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-orange-600 rounded-full flex items-center justify-center shadow-lg animate-pulse">
            <svg
        ...
        {process.env.NODE_ENV === "development" && error && (
          <div className="mb-6 p-4 bg-black/40 rounded-lg border border-red-500/30 max-h-32 overflow-auto">
